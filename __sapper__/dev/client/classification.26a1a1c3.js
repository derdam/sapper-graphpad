...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p, file$2, 28, 4, 453);
		},
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(input0, file$2, 15, 3, 203);
			attr(input1, "type", "radio");
			attr(input1, "group", options);
			input1.value = 1;
			add_location(input1, file$2, 18, 1, 273);
			add_location(label0, file$2, 17, 3, 264);
			attr(input2, "type", "radio");
			attr(input2, "group", options);
			input2.value = 2;
			add_location(input2, file$2, 23, 1, 348);
			add_location(label1, file$2, 22, 0, 339);
			add_location(button, file$2, 30, 4, 485);
			add_location(div, file$2, 12, 1, 182);
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = ($$dirty = { option1: 1, option: 1 }) => {
		if ($$dirty.option1 || $$dirty.option) { $$invalidate('isProfessionalEligible', isProfessionalEligible = 
        option1 || option > 0); }
	};
