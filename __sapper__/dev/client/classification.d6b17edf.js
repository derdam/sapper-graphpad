...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(input0, file$2, 17, 1, 195);
			add_location(label0, file$2, 16, 0, 186);
			ctx.$$binding_groups[0].push(input1);
			attr(input1, "type", "radio");
			input1.__value = 2;
			input1.value = input1.__value;
			add_location(input1, file$2, 22, 1, 274);
			add_location(label1, file$2, 21, 0, 265);
			add_location(div, file$2, 13, 1, 168);
