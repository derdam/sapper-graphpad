...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p, file$2, 26, 4, 389);
		},
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(input0, file$2, 16, 1, 201);
			add_location(label0, file$2, 15, 3, 192);
			ctx.$$binding_groups[0].push(input1);
			attr(input1, "type", "radio");
			input1.__value = 2;
			input1.value = input1.__value;
			add_location(input1, file$2, 21, 1, 280);
			add_location(label1, file$2, 20, 0, 271);
			add_location(button, file$2, 28, 4, 421);
