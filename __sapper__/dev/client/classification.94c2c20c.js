...
// (42:5) {#if isProfessionalEligible}
function create_if_block(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t = claim_text(button_nodes, "No, thanks.");
			button_nodes.forEach(detach);
			this.h();
		},
		...
		h: function hydrate() {
			...
			add_location(button, file$2, 42, 10, 818);
			dispose = listen(button, "click", deny);
		},
...
function create_fragment$2(ctx) {
	var div, t0, label0, input0, t1, t2, label1, input1, t3, t4, t5, dispose;

	var if_block0 = (ctx.isProfessionalEligible) && create_if_block_1(ctx);

	var if_block1 = (ctx.isProfessionalEligible) && create_if_block(ctx);
