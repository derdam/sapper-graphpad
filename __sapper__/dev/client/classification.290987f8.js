...
function create_fragment$2(ctx) {
	var div1, t0, div0, t1, t2, button, t3, dispose;
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(div1_nodes, "Options\n   ");

			div0 = claim_element(div1_nodes, "DIV", {}, false);
			var div0_nodes = children(div0);

			t1 = claim_text(div0_nodes, "You can");
		...
		h: function hydrate() {
			add_location(div0, file$2, 6, 3, 94);
			add_location(button, file$2, 7, 4, 117);
			add_location(div1, file$2, 4, 1, 74);
			dispose = listen(button, "click", lsFin.setProfessional);
		},
