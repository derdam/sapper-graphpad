...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p, file$2, 42, 4, 595);
			button.disabled = button_disabled_value = !ctx.isProfessionalEligible;
			add_location(button, file$2, 43, 6, 619);
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(input2, file$2, 36, 1, 485);
			add_location(label2, file$2, 35, 0, 476);
			add_location(button, file$2, 46, 7, 772);
