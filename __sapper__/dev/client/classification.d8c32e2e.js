...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(input0, file$2, 20, 1, 273);
			add_location(label0, file$2, 19, 0, 264);
			ctx.$$binding_groups[0].push(input1);
			attr(input1, "type", "radio");
			input1.__value = 2;
			input1.value = input1.__value;
			add_location(input1, file$2, 25, 1, 352);
			add_location(label1, file$2, 24, 0, 343);
			add_location(div, file$2, 16, 1, 246);
