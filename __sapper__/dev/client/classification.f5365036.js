import { S as SvelteComponentDev, i as init, s as safe_not_equal, e as element, o as text, a as claim_element, b as children, p as claim_text, d as detach, g as add_location, E as listen, h as insert, q as append, n as noop, u as space, x as mount_component, t as transition_in, l as transition_out, z as destroy_component, f as attr, r as set_data, C as check_outros, J as validate_store, K as subscribe, B as group_outros } from './chunk.b4b1df76.js';
...
// (15:4) {#if isProfessionalEligible}
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p, file$2, 15, 4, 241);
		},
...
function create_fragment$2(ctx) {
	var div, t0, t1, button, t2, dispose;
	...
	return {
		...
		h: function hydrate() {
			add_location(button, file$2, 17, 4, 272);
...
function instance($$self, $$props, $$invalidate) {
  let option2 = undefined;
	...
	$$self.$$.update = ($$dirty = { option1: 1, option2: 1 }) => {
		if ($$dirty.option1 || $$dirty.option2) { $$invalidate('isProfessionalEligible', isProfessionalEligible = 
         option2); }
	};

	return { isProfessionalEligible };
}
