...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p, file$2, 28, 4, 465);
		},
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(input0, file$2, 15, 3, 215);
			attr(input1, "type", "radio");
			attr(input1, "group", options);
			input1.value = 1;
			add_location(input1, file$2, 18, 1, 285);
			add_location(label0, file$2, 17, 3, 276);
			attr(input2, "type", "radio");
			attr(input2, "group", options);
			input2.value = 2;
			add_location(input2, file$2, 23, 1, 360);
			add_location(label1, file$2, 22, 0, 351);
			add_location(button, file$2, 30, 4, 497);
