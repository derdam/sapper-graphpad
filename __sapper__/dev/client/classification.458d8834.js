...
function create_fragment$2(ctx) {
	...
	return {
		c: function create() {
			...
			t0 = text("Options\n \n\n\n    ");
			button = element("button");
			t1 = text("I'm eligible to be classified as a setProfessional Client.");
			this.h();
		},
		...
		l: function claim(nodes) {
			...
			t1 = claim_text(button_nodes, "I'm eligible to be classified as a setProfessional Client.");
			button_nodes.forEach(detach);
			div_nodes.forEach(detach);
			this.h();
		},
		...
		h: function hydrate() {
			add_location(button, file$2, 16, 4, 210);
