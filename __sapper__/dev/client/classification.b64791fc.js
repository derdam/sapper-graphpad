...
// (37:4) {#if isProfessionalEligible}
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(input0, file$2, 27, 1, 359);
			add_location(label0, file$2, 26, 0, 350);
			ctx.$$binding_groups[0].push(input1);
			attr(input1, "type", "radio");
			input1.__value = 2;
			input1.value = input1.__value;
			add_location(input1, file$2, 32, 1, 438);
			add_location(label1, file$2, 31, 0, 429);
			add_location(div, file$2, 23, 1, 332);
