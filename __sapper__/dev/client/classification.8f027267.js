...
// (32:4) {#if isProfessionalEligible}
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(input0, file$2, 22, 1, 279);
			add_location(label0, file$2, 21, 0, 270);
			ctx.$$binding_groups[0].push(input1);
			attr(input1, "type", "radio");
			input1.__value = 2;
			input1.value = input1.__value;
			add_location(input1, file$2, 27, 1, 358);
			add_location(label1, file$2, 26, 0, 349);
			add_location(div, file$2, 18, 1, 252);
