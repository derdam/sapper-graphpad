import { S as SvelteComponentDev, i as init, s as safe_not_equal, e as element, o as text, a as claim_element, b as children, p as claim_text, d as detach, g as add_location, E as listen, h as insert, q as append, n as noop, x as mount_component, t as transition_in, l as transition_out, z as destroy_component, u as space, f as attr, r as set_data, C as check_outros, J as validate_store, K as subscribe, B as group_outros } from './chunk.b4b1df76.js';
...
function create_fragment$2(ctx) {
	var div, t0, p, t1, button, t2, current, dispose;

	var eligible = new Eligible({ $$inline: true });
	...
	return {
		c: function create() {
			...
			t1 = text("/p>\n    ");
			button = element("button");
			t2 = text("I'm eligible to be classified as a setProfessional Client.");
			this.h();
		},
		...
		l: function claim(nodes) {
			...
			eligible.$$.fragment.l(p_nodes);
			t1 = claim_text(p_nodes, "/p>\n    ");

			button = claim_element(p_nodes, "BUTTON", {}, false);
			var button_nodes = children(button);

			t2 = claim_text(button_nodes, "I'm eligible to be classified as a setProfessional Client.");
			button_nodes.forEach(detach);
		...
		h: function hydrate() {
			add_location(button, file$2, 16, 4, 241);
			add_location(p, file$2, 15, 4, 209);
			add_location(div, file$2, 11, 1, 185);
			dispose = listen(button, "click", lsFin.setProfessional);
		},
		...
		m: function mount(target, anchor) {
			...
			append(div, t0);
			append(div, p);
			mount_component(eligible, p, null);
			append(p, t1);
			append(p, button);
			append(button, t2);
			current = true;
		...
		i: function intro(local) {
			if (current) return;
			transition_in(eligible.$$.fragment, local);

			current = true;
		},

		o: function outro(local) {
			transition_out(eligible.$$.fragment, local);
			current = false;
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = ($$dirty = { option1: 1, option2: 1 }) => {
		if ($$dirty.option1 || $$dirty.option2) ;
	};
...
function create_fragment$3(ctx) {
	...
	var if_block1 = (ctx.$lsFin.clientType === "Private Client") && create_if_block();
