...
import { H as Heading, i as io, f as fade } from './chunk.54fb5fdb.js';
...
// (179:8) {#each messages as message}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(li, file, 179, 10, 3252);
		},
...
function create_fragment(ctx) {
	var meta, t0, body, div1, t1, div0, ul, t2, form, input, t3, button, t4, t5, p, t6, t7_value = ctx.numUsersConnected == 1 ? 'is' : 'are', t7, t8, t9, t10, t11_value = ctx.numUsersConnected == 1 ? 'user' : 'users', t11, t12, current, dispose;
