...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p, file$2, 36, 4, 514);
			button.disabled = button_disabled_value = !ctx.isProfessionalEligible;
			add_location(button, file$2, 37, 6, 538);
...
function create_fragment$2(ctx) {
	var div, t0, label0, input0, t1, t2, label1, input1, t3, t4, t5, button, t6, button_disabled_value, dispose;
	...
	return {
		c: function create() {
			...
			t5 = space();
			button = element("button");
			t6 = text("I confirm i'm a private Client.");
			this.h();
		},
		...
		l: function claim(nodes) {
			...
			button = claim_element(div_nodes, "BUTTON", { disabled: true }, false);
			var button_nodes = children(button);

			t6 = claim_text(button_nodes, "I confirm i'm a private Client.");
			button_nodes.forEach(detach);
			div_nodes.forEach(detach);
			this.h();
		},
		...
		h: function hydrate() {
			...
			button.disabled = button_disabled_value = !ctx.isProfessionalEligible;
			add_location(button, file$2, 40, 7, 691);
