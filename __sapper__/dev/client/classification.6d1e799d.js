...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(input0, file$2, 22, 1, 275);
			add_location(label0, file$2, 21, 0, 266);
			ctx.$$binding_groups[0].push(input1);
			attr(input1, "type", "radio");
			input1.__value = 2;
			input1.value = input1.__value;
			add_location(input1, file$2, 27, 1, 354);
			add_location(label1, file$2, 26, 0, 345);
			add_location(div, file$2, 18, 1, 248);
