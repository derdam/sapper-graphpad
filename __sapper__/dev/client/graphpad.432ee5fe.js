...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div, "id", "mynet");
			add_location(div, file, 188, 2, 3454);
			attr(button0, "class", "svelte-1888aql");
			add_location(button0, file, 189, 2, 3493);
			attr(button1, "class", "svelte-1888aql");
			add_location(button1, file, 190, 2, 3546);
			attr(button2, "class", "svelte-1888aql");
			add_location(button2, file, 191, 2, 3593);
			attr(button3, "class", "svelte-1888aql");
			add_location(button3, file, 192, 1, 3634);
			attr(input0, "class", "svelte-1888aql");
			add_location(input0, file, 193, 7, 3696);
			attr(input1, "class", "svelte-1888aql");
			add_location(input1, file, 194, 7, 3730);
			attr(body, "class", "svelte-1888aql");
			add_location(body, file, 187, 0, 3445);
