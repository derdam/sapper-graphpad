...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p, file$2, 28, 4, 463);
		},
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			input2.value = 2;
			add_location(input2, file$2, 23, 1, 359);
			add_location(label1, file$2, 22, 0, 350);
			add_location(button, file$2, 30, 4, 495);
