...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div, "id", "mynet");
			add_location(div, file, 190, 2, 3484);
			attr(button0, "class", "svelte-1888aql");
			add_location(button0, file, 191, 2, 3523);
			attr(button1, "class", "svelte-1888aql");
			add_location(button1, file, 192, 2, 3576);
			attr(button2, "class", "svelte-1888aql");
			add_location(button2, file, 193, 2, 3623);
			attr(button3, "class", "svelte-1888aql");
			add_location(button3, file, 194, 1, 3664);
			attr(input0, "class", "svelte-1888aql");
			add_location(input0, file, 195, 7, 3726);
			attr(input1, "class", "svelte-1888aql");
			add_location(input1, file, 196, 7, 3760);
			attr(body, "class", "svelte-1888aql");
			add_location(body, file, 189, 0, 3475);
