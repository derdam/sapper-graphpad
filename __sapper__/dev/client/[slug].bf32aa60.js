import { S as SvelteComponentDev, i as init, m as globals, s as safe_not_equal, e as element, u as space, o as text, a as claim_element, b as children, d as detach, p as claim_text, f as attr, g as add_location, E as listen, q as append, h as insert, n as noop, H as run_all, J as onMount } from './chunk.0e38c6f1.js';
import { i as io } from './chunk.54fb5fdb.js';
import { Y as YO, h as hC } from './chunk.7b6c5703.js';

/* src/routes/graphpads/[slug].svelte generated by Svelte v3.6.7 */
const { console: console_1, document: document_1 } = globals;

const file = "src/routes/graphpads/[slug].svelte";
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div, "id", "mynet");
			add_location(div, file, 179, 2, 3220);
			attr(button0, "class", "svelte-1888aql");
			add_location(button0, file, 180, 2, 3259);
			attr(button1, "class", "svelte-1888aql");
			add_location(button1, file, 181, 2, 3312);
			attr(button2, "class", "svelte-1888aql");
			add_location(button2, file, 182, 2, 3359);
			attr(button3, "class", "svelte-1888aql");
			add_location(button3, file, 183, 1, 3400);
			attr(input0, "class", "svelte-1888aql");
			add_location(input0, file, 184, 11, 3466);
			attr(input1, "class", "svelte-1888aql");
			add_location(input1, file, 185, 11, 3504);
			attr(p, "class", "svelte-1888aql");
			add_location(p, file, 184, 1, 3456);
			attr(body, "class", "svelte-1888aql");
			add_location(body, file, 178, 0, 3211);
...
class Slug extends SvelteComponentDev {
	constructor(options) {
		...
		if (ctx.preload === undefined && !('preload' in props)) {
			console_1.warn("<Slug> was created without expected prop 'preload'");
		}
	}
