...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p, file$2, 42, 4, 610);
			button.disabled = button_disabled_value = !ctx.isProfessionalEligible;
			add_location(button, file$2, 43, 6, 634);
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(input0, file$2, 26, 1, 334);
			add_location(label0, file$2, 25, 0, 325);
			ctx.$$binding_groups[0].push(input1);
			attr(input1, "type", "radio");
			input1.__value = 2;
			input1.value = input1.__value;
			add_location(input1, file$2, 31, 1, 413);
			add_location(label1, file$2, 30, 0, 404);
			ctx.$$binding_groups[0].push(input2);
			attr(input2, "type", "radio");
			input2.__value = 0;
			input2.value = input2.__value;
			add_location(input2, file$2, 36, 1, 493);
			add_location(label2, file$2, 35, 0, 484);
			add_location(button, file$2, 46, 7, 787);
			add_location(div, file$2, 22, 1, 307);
