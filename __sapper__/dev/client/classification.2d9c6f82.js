...
function create_fragment$2(ctx) {
	var div, t0, p, t1, t2, button, t3, dispose;
	...
	return {
		c: function create() {
			...
			t2 = space();
			button = element("button");
			t3 = text("I'm eligible to be classified as a setProfessional Client.");
			this.h();
		},
		...
		l: function claim(nodes) {
			...
			t1 = claim_text(p_nodes, "Eligible>");
			...
			t3 = claim_text(button_nodes, "I'm eligible to be classified as a setProfessional Client.");
			button_nodes.forEach(detach);
			div_nodes.forEach(detach);
			this.h();
		},
		...
		h: function hydrate() {
			...
			add_location(button, file$2, 16, 4, 230);
