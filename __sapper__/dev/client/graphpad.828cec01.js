...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div, "id", "mynet");
			add_location(div, file, 190, 2, 3473);
			attr(button0, "class", "svelte-1888aql");
			add_location(button0, file, 191, 2, 3512);
			attr(button1, "class", "svelte-1888aql");
			add_location(button1, file, 192, 2, 3565);
			attr(button2, "class", "svelte-1888aql");
			add_location(button2, file, 193, 2, 3612);
			attr(button3, "class", "svelte-1888aql");
			add_location(button3, file, 194, 1, 3653);
			attr(input0, "class", "svelte-1888aql");
			add_location(input0, file, 195, 7, 3715);
			attr(input1, "class", "svelte-1888aql");
			add_location(input1, file, 196, 7, 3749);
			attr(body, "class", "svelte-1888aql");
			add_location(body, file, 189, 0, 3464);
