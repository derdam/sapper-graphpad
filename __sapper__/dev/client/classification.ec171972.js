...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p, file$2, 42, 4, 601);
			button.disabled = button_disabled_value = !ctx.isProfessionalEligible;
			add_location(button, file$2, 43, 6, 625);
...
function create_fragment$2(ctx) {
	var div, t0, label0, input0, t1, t2, label1, input1, t3, t4, label2, input2, t5, t6, t7, button, t8, dispose;
	...
	return {
		c: function create() {
			...
			t7 = space();
			button = element("button");
			t8 = text("I confirm i'm a private Client.");
			this.h();
		},
		...
		l: function claim(nodes) {
			...
			t8 = claim_text(button_nodes, "I confirm i'm a private Client.");
			button_nodes.forEach(detach);
			div_nodes.forEach(detach);
			this.h();
		},
		...
		h: function hydrate() {
			...
			add_location(input0, file$2, 26, 1, 326);
			add_location(label0, file$2, 25, 0, 317);
			ctx.$$binding_groups[0].push(input1);
			attr(input1, "type", "radio");
			input1.__value = 2;
			input1.value = input1.__value;
			add_location(input1, file$2, 31, 1, 405);
			add_location(label1, file$2, 30, 0, 396);
			ctx.$$binding_groups[0].push(input2);
			attr(input2, "type", "radio");
			input2.__value = 0;
			input2.value = input2.__value;
			add_location(input2, file$2, 37, 1, 486);
			add_location(label2, file$2, 36, 0, 477);
			add_location(button, file$2, 46, 7, 778);
			add_location(div, file$2, 22, 1, 299);

			dispose = [
				listen(input0, "change", ctx.input0_change_handler),
				listen(input1, "change", ctx.input1_change_handler),
				listen(input2, "change", ctx.input2_change_handler),
				listen(button, "click", next)
			];
		},
