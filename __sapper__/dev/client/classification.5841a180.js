...
function create_if_block(ctx) {
	...
	return {
		c: function create() {
			...
			t4 = text("I'm eligible to be classified as a setProfessional Client.");
			this.h();
		},
		...
		l: function claim(nodes) {
			...
			t2 = claim_text(button0_nodes, "I'm eligible to be classified as a setProfessional Client.");
			...
			t4 = claim_text(button1_nodes, "I'm eligible to be classified as a setProfessional Client.");
		...
		h: function hydrate() {
			...
			add_location(button0, file$2, 27, 6, 387);
			button1.disabled = button1_disabled_value = !ctx.isProfessionalEligible;
			add_location(button1, file$2, 28, 6, 537);

			dispose = [
				listen(button0, "click", lsFin.setProfessional),
				listen(button1, "click", lsFin.setProfessional)
			];
		},
