...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(input0, file$2, 19, 1, 244);
			add_location(label0, file$2, 18, 0, 235);
			ctx.$$binding_groups[0].push(input1);
			attr(input1, "type", "radio");
			input1.__value = 2;
			input1.value = input1.__value;
			add_location(input1, file$2, 24, 1, 323);
			add_location(label1, file$2, 23, 0, 314);
			add_location(div, file$2, 15, 1, 217);
