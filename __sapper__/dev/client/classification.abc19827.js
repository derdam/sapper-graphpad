...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p, file$2, 28, 4, 450);
		},
...
function create_fragment$2(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			input1 = claim_element(label0_nodes, "INPUT", { type: true, value: true }, false);
			...
			input2 = claim_element(label1_nodes, "INPUT", { type: true, value: true }, false);
		...
		h: function hydrate() {
			...
			add_location(input2, file$2, 23, 1, 341);
			add_location(label1, file$2, 22, 0, 332);
			add_location(button, file$2, 30, 4, 482);
