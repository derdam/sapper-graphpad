...
// (20:4) {#if isProfessionalEligible}
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p, file$2, 20, 4, 316);
		},
...
function create_fragment$2(ctx) {
	var div, t0, input, t1, t2, button, t3, dispose;
	...
	return {
		...
		l: function claim(nodes) {
			...
			input = claim_element(div_nodes, "INPUT", { type: true }, false);
		...
		h: function hydrate() {
			...
			add_location(input, file$2, 15, 3, 215);
			add_location(button, file$2, 22, 4, 348);
			add_location(div, file$2, 12, 1, 194);
		...
		p: function update(changed, ctx) {
			if (changed.option1) input.checked = ctx.option1;
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = ($$dirty = { option1: 1 }) => {
		if ($$dirty.option1) { $$invalidate('isProfessionalEligible', isProfessionalEligible = 
        option1 || option2 || option > 0); }
	};
